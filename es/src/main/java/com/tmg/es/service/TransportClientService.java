...
public interface TransportClientService {
     ...
     * @throws Exception
     */
    long countByCondition(String index, QueryBuilder queryBuilder)throws Exception;
     ...
     * @return
     */
    Aggregations buckets(String index, String type, QueryBuilder queryBuilder, List<AbstractAggregationBuilder> aggregations);

    Aggregations buckets(String index, String type, QueryBuilder queryBuilder, List<AbstractAggregationBuilder> aggregations, PageUtil pageUtil);
     ...
     * @return
     */
    SearchResponse aggregation(String index, String type, QueryBuilder queryBuilder, List<AbstractAggregationBuilder> aggregations, int size);

    /**
     * 批量查询
     *
     * @param multiSearchInfos
     * @return
     */
    MultiSearchResponse multiSearch(List<MultiSearchInfo> multiSearchInfos);
