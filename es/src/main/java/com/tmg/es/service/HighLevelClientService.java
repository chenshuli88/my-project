...
public interface HighLevelClientService {
     ...
     * @throws IOException
     */
    List<Map<String,Object>> multiSearchWithTemplateId(List<String> indexNames, List<String> templateIds, List<Map<String, Object>> params) throws IOException;

    /**
     * 使用已存储的模板进行批量查询
     * @param indexName 索引名称，多个查询均在该索引上执行
     * @param templateIds 模板名称序列
     * @param params 依次对应各模板的批量查询参数序列
     * @return
     * @throws IOException
     */
    List<Map<String,Object>> multiSearchWithTemplateId(String indexName, List<String> templateIds, List<Map<String, Object>> params) throws IOException;

    /**
     * 使用已存储的模板进行批量查询
     * @param indexName 索引名称，多个查询均在该索引上执行
     * @param templateId 模板名称，多个查询均使用该模板
     * @param params  批量查询参数序列
     * @return
     * @throws IOException
     */
    List<Map<String,Object>> multiSearchWithTemplateId(String indexName, String templateId, List<Map<String, Object>> params) throws IOException;

    /**
     * 使用外部传入的模板source进行批量查询
     * @param indexNames 索引名称序列
     * @param sources 依次对应各索引的模板source内容序列
     * @param params 依次对应各模板的批量查询参数序列
     * @return
     * @throws IOException
     */
    List<Map<String,Object>> multiSearchWithTemplateSource(List<String> indexNames, List<String> sources, List<Map<String, Object>> params) throws IOException;

    /**
     * 使用外部传入的模板source进行批量查询
     * @param indexName 索引名称，多个查询均在该索引上执行
     * @param sources 模板source内容序列
     * @param params 依次对应各模板的批量查询参数序列
     * @return
     * @throws IOException
     */
    List<Map<String,Object>> multiSearchWithTemplateSource(String indexName, List<String> sources, List<Map<String, Object>> params) throws IOException;


    /**
     * 使用外部传入的模板source进行批量查询
     * @param indexName 索引名称，多个查询均在该索引上执行
     * @param source 模板source内容，多个查询均使用该模板
     * @param params 批量查询参数序列
     * @return
     * @throws IOException
     */
    List<Map<String,Object>> multiSearchWithTemplateSource(String indexName, String source, List<Map<String, Object>> params) throws IOException;
}
